...
The STRUDEL ecosystem and community are developing and we therefore use a light-weight governance. We recommend the steering committee and sub-groups evaluate the governance model in a year to ensure the governance is aligned with community needs. 

**Acknowledgement.** When developing the [governance procedures described in this repo](GOVERNANCE.md), we referenced:

* [The Carpentries Collaborative Lesson Development Training](https://carpentries.github.io/lesson-development-training/project-management.html)  
* [The Carpentries Lesson Program Governor Handbook](https://docs.carpentries.org/handbooks/lesson_program_governors.html)  
* [The Apache Foundation's decision making protocols](https://community.apache.org/committers/decisionMaking.html)  
